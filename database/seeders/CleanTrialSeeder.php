...
class CleanTrialSeeder extends Seeder
{
    public function run(): void
    {
        Schema::disableForeignKeyConstraints();

        // 1. Kosongkan seluruh rekaman operasional & transaksi
        Absensi::truncate();
        IzinSiswa::truncate();
        IzinGuru::truncate();
        ...
        // 2. Kosongkan seluruh Master Data (Siswa, Guru, Rombel)
        ...
        // 3. Inisialisasi Akun Utama Administrator (Untuk Login Trial)
        User::create([
        ...
        // 4. Inisialisasi Profil Sekolah SMKN 1 Air Naningan
        ...
        // 5. Inisialisasi Pengaturan Notifikasi & Gateway WA Standar
        ...
        // 6. Inisialisasi Tahun Ajaran Baru 2026/2027 (Aktif)
        TahunAjaran::create([
            'nama'      => '2026/2027',
            'is_active' => true,
        ]);
