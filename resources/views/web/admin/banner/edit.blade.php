      ...
      <form action="{{ route('admin.banner.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="display:grid; grid-template-columns:1fr 140px; gap:16px; margin-bottom:16px;">
          ...
          <div>
            ...
            <input type="number" name="urutan" value="{{ old('urutan', $banner->urutan) }}" min="1" required style="width:100%; padding:9px 12px; font-size:13px; border-radius:6px; border:1px solid var(--border-2); background:var(--bg-3); color:var(--text);">
          </div>
        </div>
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-bottom:16px;">
          ...
          <div>
            ...
            <input type="text" name="tag_overlay" value="{{ old('tag_overlay', $banner->tag_overlay) }}" placeholder="Contoh: Bebas Biaya Pendaftaran | Tanpa Uang Gedung | Lisensi BNSP" style="width:100%; padding:9px 12px; font-size:13px; border-radius:6px; border:1px solid var(--border-2); background:var(--bg-3); color:var(--text);">
        ...
        <div style="margin-bottom:16px;">
          ...
          <input type="text" name="judul" value="{{ old('judul', $banner->judul) }}" required placeholder="Contoh: Menempa Keahlian Teknik, Rekayasa, & Agro-Industri." style="width:100%; padding:10px 12px; font-size:14px; font-weight:700; border-radius:6px; border:1px solid var(--border-2); background:var(--bg-3); color:var(--text);">
        </div>
        ...
        <div style="margin-bottom:20px; padding:16px; background:var(--bg-3); border:1px solid var(--border); border-radius:8px;">
          ...
          <div style="display:flex; align-items:flex-start; gap:16px; flex-wrap:wrap;">
            <div id="previewContainer" style="width:200px; height:120px; border-radius:8px; overflow:hidden; border:1px solid var(--border-2); background:#0f172a; display:flex; align-items:center; justify-content:center;">
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(240px, 1fr)); gap:16px; margin-bottom:18px;">
          <div style="padding:14px; background:var(--bg-3); border:1px solid var(--border); border-radius:8px;">
            ...
            <div style="margin-bottom:8px;">
              ...
              <input type="text" name="tombol_teks_1" value="{{ old('tombol_teks_1', $banner->tombol_teks_1) }}" placeholder="Contoh: Isi Formulir PPDB Sekarang" style="width:100%; padding:7px 10px; font-size:12px; border-radius:6px; border:1px solid var(--border-2); background:var(--bg-2); color:var(--text);">
            </div>
            <div>
              <label style="font-size:11px; font-weight:700; color:var(--text-3);">Tujuan URL / Link</label>
              <input type="text" name="tombol_url_1" value="{{ old('tombol_url_1', $banner->tombol_url_1) }}" placeholder="Contoh: /ppdb/formulir atau https://..." style="width:100%; padding:7px 10px; font-size:12px; border-radius:6px; border:1px solid var(--border-2); background:var(--bg-2); color:var(--text);">
            </div>
          </div>
          ...
          <div style="padding:14px; background:var(--bg-3); border:1px solid var(--border); border-radius:8px;">
            ...
            <div style="margin-bottom:8px;">
              ...
              <input type="text" name="tombol_teks_2" value="{{ old('tombol_teks_2', $banner->tombol_teks_2) }}" placeholder="Contoh: Cek Status Seleksi" style="width:100%; padding:7px 10px; font-size:12px; border-radius:6px; border:1px solid var(--border-2); background:var(--bg-2); color:var(--text);">
            </div>
            <div>
              <label style="font-size:11px; font-weight:700; color:var(--text-3);">Tujuan URL / Link</label>
              <input type="text" name="tombol_url_2" value="{{ old('tombol_url_2', $banner->tombol_url_2) }}" placeholder="Contoh: /ppdb/status atau https://..." style="width:100%; padding:7px 10px; font-size:12px; border-radius:6px; border:1px solid var(--border-2); background:var(--bg-2); color:var(--text);">
            </div>
          </div>
          ...
          <div style="padding:14px; background:var(--bg-3); border:1px solid var(--border); border-radius:8px;">
            ...
            <div style="margin-bottom:8px;">
              ...
              <input type="text" name="tombol_teks_3" value="{{ old('tombol_teks_3', $banner->tombol_teks_3) }}" placeholder="Contoh: Tanya Panitia PPDB" style="width:100%; padding:7px 10px; font-size:12px; border-radius:6px; border:1px solid var(--border-2); background:var(--bg-2); color:var(--text);">
            </div>
            <div>
              <label style="font-size:11px; font-weight:700; color:var(--text-3);">Tujuan Link WA / URL</label>
              <input type="text" name="tombol_url_3" value="{{ old('tombol_url_3', $banner->tombol_url_3) }}" placeholder="Contoh: https://wa.me/62812... atau link lain" style="width:100%; padding:7px 10px; font-size:12px; border-radius:6px; border:1px solid var(--border-2); background:var(--bg-2); color:var(--text);">
            </div>
          </div>
        </div>
