...
<div class="app-container">
  ...
  <main class="main-content">
    ...
    <header class="topbar no-print" style="margin-bottom:16px; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px;">
      <div style="display:flex; align-items:center; gap:8px;">
        <span style="font-size:12px; font-weight:700; color:var(--text-3);">
          <a href="{{ route('admin.portal') }}" style="color:var(--text); text-decoration:none;"><i class="bi bi-command"></i> DCC</a>
          <span style="margin:0 4px; color:var(--border-2);">/</span>
          <a href="{{ route('admin.berita.index') }}" style="color:var(--text); text-decoration:none;">HUMAS &amp; WEB</a>
          <span style="margin:0 4px; color:var(--border-2);">/</span>
          <span style="color:var(--navy); font-weight:800;">Log Publikasi</span>
        </span>
      </div>
    ...
    <div style="background:linear-gradient(135deg, #1e3a8a 0%, #2563eb 50%, #0284c7 100%); border-radius:16px; padding:20px 24px; color:#ffffff; margin-bottom:20px; box-shadow:0 8px 24px rgba(37,99,235,0.2); display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:14px; border:1px solid rgba(255,255,255,0.15);">
      <div>
        <div style="display:flex; align-items:center; gap:10px; margin-bottom:4px;">
          <h1 style="margin:0; font-size:19px; font-weight:900; letter-spacing:-0.02em; display:flex; align-items:center; gap:8px; color:#ffffff;">
            <i class="bi bi-globe-americas" style="color:rgba(255,255,255,0.85);"></i> Audit Trail Modul Humas &amp; Website
          </h1>
          <span style="font-size:10px; font-weight:800; background:rgba(255,255,255,0.18); color:#f8fafc; border:1px solid rgba(255,255,255,0.25); padding:3px 9px; border-radius:999px; text-transform:uppercase; letter-spacing:0.05em;">Publikasi &amp; Konten</span>
        </div>
      ...
      <div style="display:flex; align-items:center; gap:8px;">
        <a href="{{ route('admin.berita.index') }}" class="btn" style="background:rgba(255,255,255,0.18); color:#ffffff; border:1px solid rgba(255,255,255,0.25); font-size:12px; font-weight:700; padding:8px 14px; border-radius:8px; text-decoration:none; display:inline-flex; align-items:center; gap:6px;">
          <i class="bi bi-newspaper"></i> Kelola Berita
        </a>
        <a href="{{ route('admin.banner.index') }}" class="btn" style="background:rgba(255,255,255,0.18); color:#ffffff; border:1px solid rgba(255,255,255,0.25); font-size:12px; font-weight:700; padding:8px 14px; border-radius:8px; text-decoration:none; display:inline-flex; align-items:center; gap:6px;">
          <i class="bi bi-images"></i> Banner Hero
        </a>
        @if(auth()->user()->isAdmin() || auth()->user()->isKepalaSekolah())
          <a href="{{ route('audit.index') }}" class="btn" style="background:#ffffff; color:#1e40af; font-size:12px; font-weight:900; padding:8px 14px; border-radius:8px; text-decoration:none; display:inline-flex; align-items:center; gap:6px; box-shadow:0 2px 8px rgba(0,0,0,0.15);">
    ...
    <div class="audit-kpi-grid">
      <div class="audit-kpi-card">
        ...
        <div class="audit-kpi-icon" style="color:var(--navy); background:rgba(37,99,235,0.12); border-color:var(--border);">
      ...
      <div class="audit-kpi-card">
        ...
        <div class="audit-kpi-icon" style="color:#0ea5e9; background:rgba(14,165,233,0.15); border-color:var(--border);">
      ...
      <div class="audit-kpi-card">
        ...
        <div class="audit-kpi-icon" style="color:#10b981; background:rgba(16,185,129,0.15); border-color:var(--border);">
