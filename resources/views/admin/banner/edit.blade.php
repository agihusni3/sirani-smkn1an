      ...
      <form action="{{ route('admin.banner.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-bottom:16px;">
          ...
          <div>
            ...
            <input type="text" name="tag_overlay" value="{{ old('tag_overlay', $banner->tag_overlay) }}" placeholder="Contoh: Kampus Utama • Tanggamus, Lampung" style="width:100%; padding:9px 12px; font-size:13px; border-radius:6px; border:1px solid var(--border); background:var(--surface); color:var(--text);">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-bottom:18px;">
          <div style="padding:14px; background:var(--surface); border:1px solid var(--border); border-radius:8px;">
            ...
            <div style="margin-bottom:8px;">
              ...
              <input type="text" name="tombol_teks_1" value="{{ old('tombol_teks_1', $banner->tombol_teks_1) }}" placeholder="Contoh: Eksplorasi 3 Kejuruan" style="width:100%; padding:7px 10px; font-size:12px; border-radius:6px; border:1px solid var(--border); background:var(--bg-2); color:var(--text);">
            </div>
            <div>
              <label style="font-size:11px; font-weight:700; color:var(--text-3);">Tujuan URL / Link</label>
              <input type="text" name="tombol_url_1" value="{{ old('tombol_url_1', $banner->tombol_url_1) }}" placeholder="Contoh: /kejuruan atau https://..." style="width:100%; padding:7px 10px; font-size:12px; border-radius:6px; border:1px solid var(--border); background:var(--bg-2); color:var(--text);">
            </div>
          </div>
          ...
          <div style="padding:14px; background:var(--surface); border:1px solid var(--border); border-radius:8px;">
            ...
            <div style="margin-bottom:8px;">
              ...
              <input type="text" name="tombol_teks_2" value="{{ old('tombol_teks_2', $banner->tombol_teks_2) }}" placeholder="Contoh: Pendaftaran PPDB" style="width:100%; padding:7px 10px; font-size:12px; border-radius:6px; border:1px solid var(--border); background:var(--bg-2); color:var(--text);">
            </div>
            <div>
              <label style="font-size:11px; font-weight:700; color:var(--text-3);">Tujuan URL / Link</label>
              <input type="text" name="tombol_url_2" value="{{ old('tombol_url_2', $banner->tombol_url_2) }}" placeholder="Contoh: /ppdb atau https://..." style="width:100%; padding:7px 10px; font-size:12px; border-radius:6px; border:1px solid var(--border); background:var(--bg-2); color:var(--text);">
            </div>
          </div>
        </div>
