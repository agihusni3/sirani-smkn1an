  ...
  <main class="main-content">
    ...
    <div class="ppdb-hero-bar no-print">
      ...
      <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
        <a href="{{ route('admin.portal') }}" class="btn btn-sm" style="background:rgba(255,255,255,0.12); color:#ffffff; font-weight:800; border-radius:8px; font-size:12px; padding:8px 14px; border:1px solid rgba(255,255,255,0.25); text-decoration:none; display:inline-flex; align-items:center; gap:6px;">
          <i class="bi bi-grid-3x3-gap-fill" style="color:#38bdf8;"></i> Pusat Kendali Modul
        </a>
