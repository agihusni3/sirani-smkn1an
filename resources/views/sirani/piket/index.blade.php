...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/piket.css') }}?v={{ filemtime(public_path('css/piket.css')) }}">
</head>
<body>
<div class="app-container">
  ...
  <main class="main-content">
    ...
    {{-- ══ NOTIFIKASI MODE PEKAN SUMATIF AKTIF ══ --}}
    @if($modeUjian && $modeUjian->isAktifHariIni($today))
      <div class="piket-exam-banner no-print" style="margin-bottom:14px; display:flex; align-items:center; justify-content:space-between; gap:16px; padding:12px 18px; border-radius:12px; background:linear-gradient(135deg, rgba(79, 70, 229, 0.08) 0%, rgba(124, 58, 237, 0.05) 100%); border:1px solid rgba(99, 102, 241, 0.28); box-shadow:0 2px 10px -2px rgba(99, 102, 241, 0.08); flex-wrap:wrap;">
        ...
        <div style="display:inline-flex; align-items:center; gap:9px; background:var(--bg-2, #ffffff); border:1px solid rgba(99, 102, 241, 0.25); padding:6px 14px; border-radius:10px; box-shadow:0 2px 6px rgba(0,0,0,0.03); flex-shrink:0;">
