...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/presensi-manual.css') }}?v={{ filemtime(public_path('css/presensi-manual.css')) }}">
</head>
<body>
            ...
            <div id="pickerTrigger" class="picker-trigger" style="height:42px; background:var(--bg-3);" onclick="togglePickerDropdown()">
              <div id="selectedView" style="display:none; align-items:center; justify-content:space-between; width:100%;">
                <div style="display:flex; align-items:center; gap:8px; overflow:hidden;">
                  <img id="selectedFoto" src="" alt="Foto" style="width:27px; height:36px; aspect-ratio:3/4; border-radius:5px; object-fit:cover; object-position:center 20%; border:1.5px solid rgba(0,0,0,0.15); flex-shrink:0;" />
