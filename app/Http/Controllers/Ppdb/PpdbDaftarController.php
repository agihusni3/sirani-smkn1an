...
class PpdbDaftarController extends Controller
{
    ...
    public function simpan(Request $request)
    {
        ...
        $noHpOrtu = $validated['no_hp_ortu'] ?? (($validated['no_hp_ayah'] ?? null) ?: (($validated['no_hp_ibu'] ?? null) ?: ($validated['no_hp_siswa'] ?? null)));
        $p->no_hp_ortu = $noHpOrtu;
        $p->no_hp_ayah = $noHpOrtu;
        $p->no_hp_ibu = $noHpOrtu;
